...
PR #88 "TK-412: expire idle sessions" — 1 file(s) changed.
- `src/cache/session-store.ts` — TTL constant, `lastSeenAt`, `touch`, `evictIdle`; middleware wiring lands in a follow-up PR (descoped here, see PR description)
