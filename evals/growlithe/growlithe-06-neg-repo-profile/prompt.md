...
```
Step 2 — with a sub-agent, produce the REPOSITORY profile (stack, architecture patterns, naming and code conventions, testing expectations) for this working tree, not a security assessment. `$CACHE` is `.agents/cache`; treat HEAD as `4f1c9e2a7b3d5c6e8f0a1b2c3d4e5f6a7b8c9d0e`. Relay the brief verbatim.
