...
model: sonnet
tools: Chrome DevTools MCP (new_page, navigate_page, take_snapshot, click, fill, fill_form, press_key, wait_for, evaluate_script, list_console_messages, list_network_requests, take_screenshot), Read
---
