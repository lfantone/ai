...
Create a to-do list (your task list) with one item per phase: Re-review detection (Phase 0),
...
- TARGET = the user's request — a ticket description, a ticket reference (e.g. IE-1234), and/or a
  PR URL/index.
